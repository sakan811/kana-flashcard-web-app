...
describe('SEO Metadata Configuration', () => {
  ...
  describe('Hiragana Page Metadata', () => {
    ...
    it('should have OpenGraph configuration', () => {
      expect(hiraganaMetadata.openGraph?.title).toBe('Hiragana Practice | SakuMari');
    ...
    it('should have Twitter Card configuration', () => {
      expect(hiraganaMetadata.twitter?.title).toBe('Hiragana Practice | SakuMari');
  ...
  describe('Katakana Page Metadata', () => {
    ...
    it('should have OpenGraph configuration', () => {
      expect(katakanaMetadata.openGraph?.title).toBe('Katakana Practice | SakuMari');
    ...
    it('should have Twitter Card configuration', () => {
      expect(katakanaMetadata.twitter?.title).toBe('Katakana Practice | SakuMari');
  ...
  describe('Metadata Consistency', () => {
    ...
    it('should have unique canonical URLs for each page', () => {
      ...
      expect(canonicals).toEqual(['/', '/', '/hiragana', '/katakana', '/dashboard']);
    });
  });
});