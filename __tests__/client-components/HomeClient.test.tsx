...
vi.mock("../../components/Header", () => ({
  default: ({ activeTab, setActiveTab }: any) => (
    <div data-testid="header">Header - Active: {activeTab}</div>
  ),
}));
...
describe("HomeClient Component", () => {
  ...
  describe("Unauthenticated State", () => {
    ...
    it("should render welcome message for unauthenticated users", () => {
      ...
      expect(
        screen.getByText("Japanese Kana Flashcard App"),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
    ...
    it("should show welcome card with sign-in instructions", () => {
      ...
      expect(
        screen.getByText(/Click "Sign In with Google" in the top navigation/),
      ).toBeInTheDocument();
    });
  ...
  describe("Authenticated State", () => {
    ...
    it("should show Hiragana practice card with correct content", () => {
      ...
      expect(
        screen.getByText("Practice the Hiragana characters"),
      ).toBeInTheDocument();
    ...
    it("should show Katakana practice card with correct content", () => {
      ...
      expect(
        screen.getByText("Practice the Katakana characters"),
      ).toBeInTheDocument();
    });
    ...
    it("should not show welcome card when authenticated", () => {
      ...
      expect(
        screen.queryByText("Welcome to SakuMari!"),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByText(/Sign in with your Google account/),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe("Accessibility", () => {
    ...
    it("should have accessible link texts", () => {
      ...
      expect(
        screen.getByRole("link", { name: /ひらがな Hiragana Practice/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("link", { name: /カタカナ Katakana Practice/i }),
      ).toBeInTheDocument();
      expect(
