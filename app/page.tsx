    ...
    return (
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/hiragana" className="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <Link href="/katakana" className="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div className="text-center">
        ...
        <div className="mt-8 text-center">
          <Link href="/dashboard" className="inline-block px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
            View Your Progress
          </Link>
        </div>
      </div>
